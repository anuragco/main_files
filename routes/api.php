...
Route::group(['middleware' => ['maintainance']], function () {
    ...
    // payment get sucess product inactive and vicevarsa
    // web.php or api.php
// Add the following routes for updating order and product status

Route::put('/update-order-status/{orderId}', [OrderController::class, 'updateOrderStatus'])->name('admin.update-order-status');
Route::put('/update-product-status/{productId}', [ProductController::class, 'updateProductStatus'])->name('admin.update-product-status');
